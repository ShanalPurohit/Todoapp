...
class App extends Component {
  ...
  refreshList = () => {
    axios   //Axios to send and receive HTTP requests
      .get("https://djangoapi22.herokuapp.com/api/tasks/")
  ...
  handleSubmit = item => {
    ...
    if (item.id) {
      ...
      axios
        .put(`https://djangoapi22.herokuapp.com/api/tasks/${item.id}/`, item)
        .then(res => this.refreshList());
      return;
    }
    // if new post to submit
    axios
      .post("https://djangoapi22.herokuapp.com/api/tasks/", item)
      .then(res => this.refreshList());
  };
  ...
  handleDelete = item => {
    axios
      .delete(`https://djangoapi22.herokuapp.com/api/tasks/${item.id}/`)
      .then(res => this.refreshList());
  };
